...
export const RESTAURANTS: Restaurant[] = [
  {
    ...
    menu: [
      { id: "m1", name: "Hyderabadi Chicken Biryani", description: "Long grain basmati rice cooked with succulent chicken and spices.", price: 320, image: "https://picsum.photos/seed/m1/400/300", category: "Biryani", isVeg: false, rating: true },
  ...
  },
  {
    ...
    menu: [
      { id: "m4", name: "Margherita Pizza", description: "Classic tomato sauce, mozzarella, and fresh basil.", price: 299, image: "https://picsum.photos/seed/m4/400/300", category: "Pizza", isVeg: true, rating: true },
  ...
  },
  {
    ...
    menu: [
      { id: "m7", name: "Veg Hakka Noodles", description: "Stir-fried noodles with crisp vegetables.", price: 180, image: "https://picsum.photos/seed/m7/400/300", category: "Main Course", isVeg: true, rating: true },
